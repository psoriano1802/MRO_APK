...
data class OrdenItem(
    @SerializedName("ok") val ok: String? = null,
    @SerializedName("Folio", alternate = ["folio", "FolioM"]) val folio: String? = null,
    @SerializedName("CveActivo", alternate = ["Activo"]) val activos: String? = null,
    @SerializedName("NombreActivo", alternate = ["NomActivo"]) val nomAct: String? = null,
    @SerializedName("SucOrd") val suc: String? = null,
    @SerializedName("TipOrd", alternate = ["Tipo"]) val tipo: String? = null,
